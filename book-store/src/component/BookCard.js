...
import { deletBook,editBook } from '../redux/book'
import { useDispatch } from 'react-redux'

const BookCard = ({book,setBookId}) => {
    ...
    <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
      <div className="flex items-center justify-between">
        ...
        <div className="text-gray-500 space-x-2">
          <button className="lws-edit" onClick={handelEdit}>
          ...
          <button  className="lws-delete" onClick={() => {dispatch(deletBook({id:id}))} }>
            <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
              <path stroke-linecap="round" stroke-linejoin="round"
